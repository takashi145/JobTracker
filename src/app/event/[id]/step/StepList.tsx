...
const StepList = ({ steps: initialSteps, eventId }: { steps: Step[], eventId: string }) => {
    ...
    <>
      ...
      {steps.map((step, index) => (
        <div key={step._id} className="mb-8 lg:mb-0 w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-slate-800 dark:border-gray-700">
          <h3 className='mb-3 text-xl dark:text-white font-semibold'>{index + 1}</h3>
          <div className="mb-4 flex justify-between">
            <div>
              <label htmlFor="step-name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                          ...
                          <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                              ...
                              <div className="px-6 py-6 lg:px-8">
                                  ...
                                  >
                                    ...
                                    <div className='mb-3'>
                                      <label htmlFor="step-description" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
                                      <textarea
                                    ...
                                    <div className='mb-3'>
                                      <label htmlFor="step-deadline" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
                                      <input
                                        type="date"
                                        name="step-deadline"
                                        id="step-deadline"
                                    ...
                                    <div className='mb-3'>
                                      <label htmlFor="step-status" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Status</label>
                                      <select 
                                          name="step-status" 
                                          id="step-status" 
                                          className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" 
            ...
            <div aria-hidden="true" className={`${openModal ? 'z-50' : 'hidden'} z-50 flex justify-center items-center w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full`}>
                <div className="relative w-full max-w-md max-h-full">
                    <div className="relative bg-white rounded-lg shadow dark:bg-gray-800">
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-white">ステップの追加</h3>
                            <form onSubmit={(e) => {
                                e.preventDefault();
                                addStep();
                              }} 
